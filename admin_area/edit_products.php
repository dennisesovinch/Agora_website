...
<div class="container mt-5">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-outline w-50 m-auto m-4">
            <label for="product_description" name="product_description" class="form-label">Product description</label>
            <input type="text" id="product_description" name="product_description" value="<?php echo $product_description?>"
            class="form-control"
            required="required">
        </div>
        <div class="form-outline w-50 m-auto m-4">
            <label for="product_keywords" name="product_keywords" class="form-label">Product Keywords</label>
...
if(isset($_GET['edit_products'])){
    ...
    or $product_image3=='' or $product_price==''){
        ...
        move_uploaded_file($temp_image1,"./product_images/<?php echo $product_image1");
        move_uploaded_file($temp_image2,"./product_images/<?php echo $product_image2");
        move_uploaded_file($temp_image3,"./product_images/<?php echo $product_image3");
