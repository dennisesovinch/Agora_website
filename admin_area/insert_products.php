...
<body class="bg-light">
    <div class="container mt-3">
        ...
        <select name="product_brands" id="" class="form-select" >
                <option values="">Select a Brands</option>
                <?php
            ...
            btn-warning mb-3 px-3" value="Insert Products">
    

        </div>
        <button><a href="index.php?view_products" class="text-light bg-warning py-1 px-4 ">Back</a></button>
