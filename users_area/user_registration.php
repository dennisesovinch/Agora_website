...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="mt-3 pt2">
        <input type="submit" value="Register" class="bg-warning py-2 px-3
...
<button><a href="user_login.php" class="text-light bg-warning py-1x px-2">Back</a></button>
<!-- php code -->
<?php
...
if($rows_count>0){
    ...
    user_address,user_mobile) value('$user_username',' $user_email','$hash_password',
