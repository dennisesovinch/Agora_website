...
<body class="bg-secondary">
    ...
    <form action="" method="post">
        ...
        <div class="form-outline my-5 text-center w-50 m-auto">
            <input type="submit" class="bg-warning py-2 px-3 border-5" value="Confirm"
            name="confirm_payment">
            </div>


            <!-- <input type="submit" class="bg-warning py-2 px-3 border-5" value="Back">
             <a href="profile.php"></a > -->

             <button><a href="profile.php?my_users" class="text-light bg-warning py-1 px-4 ">Back</a></button>
        </div>
    </form>
</div>
</body>
