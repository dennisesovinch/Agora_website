...
<div class="row">
  ...
  <li class="nav-item bg-warning">
          <a class="nav-link text-light" href="profile.php">Your profile</h4></a>
      </li>
      <?php
...
?>
      <li class="nav-item">
        <img src="../images/logo.jpg" class="profile_img my-4" alt="">
      </li>
      ...
      <li class="nav-item">
          <a class="nav-link text-light" href="profile.php?
          delete_account">Delete Account</a>
      </li>
      <li class="nav-item">
